...
<body onload="servletMessage()">
	...
	<script type="text/javascript">
		...
		function createAccount(){
			var f= document.getElementsByName("createAccountForm");
			
			if(blankCheck()){
				f[0].method="post";
				f[0].action="http://pmdc.kr/web/main/createAccount.do";
				f[0].submit();
			}
		}
	    ...
	    function blankCheck(){
	    	f= document.getElementsByName("createAccountForm");
	    	...
	    	if(f[0].userEmail.value==""){
	    		alert("이메일 주소를 입력해주세요.");
	    		f[0].userEmail.focus();
	    		return false;
	    	}

	    	if(f[0].emailChecked.value=="false"){
	    		alert("중복된 이메일 입니다.");
	    		f[0].userEmail.focus();
	    		return false;
	    	}
			...
			<tr id="popTable2r">
				<td>
					<label class="column">
						...
						<span class="columnText">*</span>아이디<span class="dupMsg" id="idchk"></span><br>
					...
					<label class="column">
						...
						<input class="textBox" type="text" name="userName" placeholder="한글 및 영문 대/소문자">
					</label>
					<label class="column">
						<span class="columnText">*</span>이메일<span class="dupMsg" id="emailchk"></span><br>
						<input class="textBox" type="text" id="userEmail" name="userEmail" placeholder="ex) example@domain.etc (타 계정 중복 불가)">
						<input type="hidden" id="emailChecked" name="emailChecked" value="">
					</label>
					<label class="column">
						<span class="columnText">*</span>회사명<br> 
						<input class="textBox" type="text" name="userCoName" placeholder="한글 및 영문 대/소문자, 특수문자 ()_">
					</label>
					<label class="column">
						<!-- 주소 -->
					...
					<label class="column">
						...
						<input class="textBox" type="text" placeholder="ex) 02-123-1234" name="userTel">
					</label>
					<label class="column">
						<span class="columnText">*</span>휴대전화<br>
						<input class="textBox" type="text" placeholder="ex) 010-1234-1234" name="userHp">
					</label>
				</td>
			</tr>
			<tr id="popTable3r">
				<td>
					<div id="submitButton" onClick="createAccount()">회원가입</div>
					<div id="cancelButton" onClick="window.location.href='<%=PMDUtil.PMD_URL%>'">취소</div>
				</td>
			</tr>
			</table>
		</form>
