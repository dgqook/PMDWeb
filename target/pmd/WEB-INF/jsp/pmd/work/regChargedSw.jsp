...
<body>
	...
	<div id="mid">
		...
		<script type="text/javascript">
			...
			<form name="regForm">
				<input class="textBox" type="text" name="swName" value="${swName}" readonly="readonly">
				<input class="textBox" type="text" name="swVendor" placeholder="개발사">
				<input class="textBox" type="text" name="swFile" value="${swFile}" placeholder="실행 프로세스(확장자 포함)">
