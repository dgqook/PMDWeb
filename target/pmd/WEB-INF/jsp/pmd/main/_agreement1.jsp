...
제 1 장 총칙
제 1조 [목적]
이 약관은 주식회사 엠피엠씨앤에스(이하 "회사"라 합니다)와 주식회사 엠피엠씨앤에스가 운영하는 PMD 및 그 제휴사들이 공동으로 제공하는 인터넷 서비스(이하 "서비스"라 합니다)를 이용함에 있어 회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
제 2조 [약관의 효력 및 변경]
① 이 약관은 서비스를 통하여 이를 공지함으로써 효력이 발생됩니다.
② 회사는 사정상 중요한 사유가 발생될 경우 사전 고지 없이 이 약관의 내용을 변경할 수 있으며, 약관 변경은 서비스를 통하여 7일 이전, 변경된 약관이 회원의 이해득실과 연관된 경우에는 30일 이전에 공지합니다.
...
① 제휴사 : PMD 중심으로 인터넷 서비스를 제공하는 다수의 관련 업체 및 웹사이트를 말합니다.
...
회원으로 가입하여 서비스를 이용하기를 희망하는 자는 회사가 정한 정보(회원사 소프트웨어 정보) 취합을 승인 합니다.
제 7조 [이용 신청의 승낙]
...
② 회사는 이용 신청 시 회원이 제공하는 정보, 각종 이벤트 참가를 위하여 회원이 제공하는 정보, 기타 서비스 이용 과정에서 수집되는 정보 등을 통하여 회원에 관한 정보를 수집하며, 회원의 개인정보는 본 이용계약의 이행과 본 이용계약상의 서비스 제공을 위한 목적으로 사용됩니다.
...
다른 법률에 특별한 규정이 있는 경우5. 정보통신윤리위원회가 관계법령에 의하여 요청 경우
④ 회원은 하나의 아이디로 회사 및 제휴사 웹사이트들을 별도의 회원가입 절차 없이 편리하게 이용하실 수 있습니다. 이 경우에도 개인정보의 회사 및 제휴사들 간의 공유는 회원의 동의 없이는 절대 이루어지지 않습니다. 단, 통합인증을 위한 최소한의 정보(아이디와 비밀번호)는 회사와 제휴사 접속 시 공유되며 회원의 동의가 없는 경우 별도로 저장되지는 않습니다.
...
⑥ 회원이 가입 시 제공한 정보는 회원 가입 시점부터 해지 완료 후 60일까지 보관할 수 있습니다.
...
제 10조 [계약 사항의 변경]
① 회원은PMD 및 제휴사의 개인정보관리 페이지를 통해 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다.
② 회원은 이용신청 시 기재한 사항이 변경되었을 경우 온라인으로 수정을 해야 하며 회원정보를 변경하지 아니하여 발생되는 문제의 책임은 회원에게 있습니다.
③ 회원이 원하는 경우 이용동의를 철회할 수 있으며, 이용동의를 철회한 경우 PMD 및 제휴사 이용에 제약이 따를 수 있습니다. 이용동의의 철회는 해지 신청을 하는 것으로 이루어집니다.
제 3 장 계약 당사자의 의무
제 11조 [회사의 의무]
...
다른 회원의 아이디와 비밀번호, 주민등록번호, 이메일주소 등을 도용하는 행위
...
기타 관계법령에 위배되는 행위
가입한 회사 소프트웨어 정보를 당사 서버에 저장을 하는 부분에 대한 승인
제 4 장 서비스 이용
제 13조 [서비스 이용 범위]
회원은 회사를 통한 소프트웨어 저작권 협회에 등록된 소프트웨어 확인 서비스를 이용하 실 수 있습니다.
제 14조 [정보의 제공]
① 회사는 회원이 서비스 이용 중 필요가 있다고 인정되는 다양한 정보를 공지사항이나 전자우편 등의 방법으로 회원에게 제공할 수 있습니다.
② 단, 회사는 회원이 서비스 혜택 정보 제공을 원치 않는다는 의사를 밝히는 경우 정보 제공 대상에서 해당 회원을 제외하여야 하며, 대상에서 제외되어 서비스 정보를 제공 받지 못해 불이익이 발생하더라도 이에 대해서는 회사가 책임지지 않습니다.
제 15조 [요금, 유료정보 및 결제 등]
① 회사가 제공하는 서비스는 기본적으로 유료 입니다. 
② 유료서비스 및 유료정보는 서비스 이용 시마다 요금이 결제되는 '요금 결제후 일정기간동안 서비스를 이용할 수 있는 '가입형 유료서비스(정보)'가 있습니다.
제 16조 [회원의 게시물]
...
② 회사는 서비스를 일정범위로 분할하여 각 범위 별로 이용가능 시간을 별도로 정할 수 있습니다. 이 경우 사전에 공지를 통해 그 내용을 알립니다.제 19 조 (서비스 이용 책임)회원은 회사에서 권한 있는 사원이 서명한 명시적인 서면에 구체적으로 허용한 경우를 제외하고는 서비스를 이용하여 상품을 판매하는 영업활동을 할 수 없으며 특히 해킹, 돈벌이 광고, 음란 사이트 등을 통한 상업행위, 상용S/W 불법배포 등을 할 수 없습니다. 이를 어기고 발생한 영업활동의 결과 및 손실, 관계기관에 의한 구속 등 법적 조치 등에 관해서는 회사가 책임을 지지 않습니다.
제 19조 [서비스 이용 책임]
...
제 22조 [휴면계정]
① 회원이 1년 이상 로그인을 하지 않은 경우 회원의 계정을 휴면상태로 전환하고, 해당 계정의 개인정보를 다른 회원의 개인정보와 분리하여 별도로 보관합니다.
② 휴면상태의 계정으로는 알툴즈 회원 로그인 서비스 이용이 제한되고 회사는 휴면상태로 전환된 계정의 개인정보를 이용, 제공하지 않습니다.
③ 회사는 처리예정일로부터 30일 이전에 해당 사실을 회원에게 사전 통지하고 휴면계정 전환 이후에 회원은 홈페이지에서 별도의 인증 절차를 통해 휴면을 해제할 수 있습니다.
제 6 장 손해배상 및 기타 사항
제 23조 [손해배상]
회사는 이용 요금이 무료인 서비스 이용과 관련하여 회원에게 발생한 손해가 회사 측의 고의적인 과실로 인한 경우가 아니면 책임을 지지 않습니다. 유료 서비스의 경우는 서비스별 이용약관에 따릅니다.
제 24조 [면책조항]
